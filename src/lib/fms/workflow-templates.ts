...
export const FMS_WORKFLOW_TEMPLATES: FmsWorkflowTemplate[] = [
  ...
  },
  {
    ...
    department: "sales",
    name: "Sales Order",
    description: "Order entry and sales department approval after quotation lock.",
    steps: [
      {
        stepName: "Order Entry",
        ownerRoleLabel: "Sales",
        howInstructions:
          "Confirm customer PO, delivery date, payment terms, and line items from quotation.",
        tatValue: "4",
        tatUnit: "hours",
      },
      {
        stepName: "Order Approval",
        ownerRoleLabel: "Sales Manager",
        howInstructions: "Review order value, advance received, and approve for fulfillment.",
        tatValue: "1",
        tatUnit: "days",
      },
    ],
  },
  {
    ...
    name: "Stock Check Fulfillment",
    description: "Verify stock availability and decide dispatch or purchase path.",
    steps: [
      {
        stepName: "Stock Availability",
        ownerRoleLabel: "Store",
        howInstructions: "Check on-hand stock against sales order line items.",
        tatValue: "4",
        tatUnit: "hours",
      },
      {
        stepName: "Fulfillment Decision",
        ownerRoleLabel: "Inventory",
        howInstructions:
          "Mark ready for dispatch or record shortage for purchase requisition.",
        tatValue: "1",
        tatUnit: "days",
      },
    ],
  },
  {
    ...
    description: "Pack, dispatch, deliver, and confirm with customer.",
    steps: [
      {
        stepName: "Packing List",
        ownerRoleLabel: "Packing",
        howInstructions: "Prepare packing list and confirm quantities per line item.",
        tatValue: "4",
        tatUnit: "hours",
      },
      {
        stepName: "Pre-dispatch QC",
        ownerRoleLabel: "Quality",
        howInstructions: "Inspect packed goods before loading.",
        tatValue: "4",
        tatUnit: "hours",
      },
      {
        stepName: "Loading",
        ownerRoleLabel: "Dispatch",
        howInstructions: "Load vehicle and record transporter details.",
        tatValue: "4",
        tatUnit: "hours",
      },
      {
        stepName: "Dispatch",
        ownerRoleLabel: "Dispatch",
        howInstructions: "Hand over to transporter and share LR/AWB.",
        tatValue: "1",
        tatUnit: "days",
      },
      {
        stepName: "Unloading",
        ownerRoleLabel: "Dispatch",
        howInstructions: "Confirm goods unloaded at customer site.",
        tatValue: "2",
        tatUnit: "days",
      },
      {
        stepName: "Customer Confirmation",
        ownerRoleLabel: "Sales",
        howInstructions: "Obtain customer sign-off or delivery confirmation.",
        tatValue: "1",
        tatUnit: "days",
      },
      {
        stepName: "Notify Parties",
        ownerRoleLabel: "Dispatch",
        howInstructions: "Notify accounts, sales, and customer that delivery is complete.",
        tatValue: "4",
        tatUnit: "hours",
      },
    ],
  ...
  },
  {
    ...
    name: "Recruitment",
    description:
      "Hiring pipeline — resume sourcing through induction, OJT, and handover to department head.",
    steps: [
      {
        stepName: "Resume Sourcing",
        ownerRoleLabel: "HR",
        howInstructions:
          "Source resumes from job portals, referrals, and consultants for the open position.",
        tatValue: "3",
        tatUnit: "days",
      },
      {
        stepName: "Resume Shortlisting",
        ownerRoleLabel: "HR",
        howInstructions: "Screen resumes against the JD and shortlist candidates.",
        tatValue: "2",
        tatUnit: "days",
      },
      {
        stepName: "Interview Call",
        ownerRoleLabel: "HR",
        howInstructions: "Call shortlisted candidates and schedule interview slots.",
        tatValue: "1",
        tatUnit: "days",
      },
      {
        stepName: "Interview Shortlist",
        ownerRoleLabel: "HR Manager",
        howInstructions: "Conduct first-round interview and shortlist for the final round.",
        tatValue: "2",
        tatUnit: "days",
      },
      {
        stepName: "Final Round",
        ownerRoleLabel: "Department Head",
        howInstructions: "Conduct the final round and select the candidate.",
        tatValue: "2",
        tatUnit: "days",
      },
      {
        stepName: "Offer Letter",
        ownerRoleLabel: "HR",
        howInstructions: "Issue offer letter to the selected candidate and confirm acceptance.",
        tatValue: "1",
        tatUnit: "days",
      },
      {
        stepName: "Joining",
        ownerRoleLabel: "HR",
        howInstructions: "Confirm joining date and collect documents on day one.",
        tatValue: "7",
        tatUnit: "days",
      },
      {
        stepName: "Appointment Letter",
        ownerRoleLabel: "HR",
        howInstructions: "Issue appointment letter on joining.",
        tatValue: "1",
        tatUnit: "days",
      },
      {
        stepName: "Induction",
        ownerRoleLabel: "HR",
        howInstructions: "Company induction — policies, teams, and tools.",
        tatValue: "2",
        tatUnit: "days",
      },
      {
        stepName: "OJT via Recorded Videos",
        ownerRoleLabel: "HR",
        howInstructions:
          "On-the-job training through recorded videos; verify completion and quiz scores.",
        tatValue: "5",
        tatUnit: "days",
      },
      {
        stepName: "Department Handover",
        ownerRoleLabel: "Department Head",
        howInstructions:
          "Hand over the trained candidate to the department head with KRA/KPI defined.",
        tatValue: "1",
        tatUnit: "days",
      },
    ],
